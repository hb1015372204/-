    ...
    var effect = {
        ...
        seTemplet: function () {
            var config = this.options,
                selectemplet = '',
                placeholder,labelName, field, forbid, citygrade, active, hide,
            ...
            for (var i = 0; i < config.level; i++) { //循环定义的级别
                ...
                labelName=config.selectpattern[i].labelName;
                ...
                if (config.renderMode) {
                    //模拟
                    selectemplet += '<div class="city-sitem"><label>'+labelName+'</label><div class="selector-item storey ' + citygrade + '" data-index="' + i + '">'
                        ...
                        +'<div class="selector-list listing hide">'+ searchStr +'<ul></ul></div></div>'
                    +'</div>';
                } else {
                    //原生
